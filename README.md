...
This reflects current Solana devnet network conditions and RPC endpoint variability, not program execution time. The on-chain instruction compute units are minimal—permission verification is a single bitwise AND operation. Mainnet-beta latency on a dedicated RPC endpoint is projected at 400–800ms.

## SECURITY ARCHITECTURE
Documented in `SECURITY.md`. Key mitigations include:
